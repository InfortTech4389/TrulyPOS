                            ...
                            <div class="mega-menu-container">
                                ...
                                <div class="menu-subcategories">
                                    ...
                                    <div class="subcategory-group" id="specialized-subcategories">
                                        ...
                                        <a href="<?php echo base_url('industries/apparel-footwear'); ?>" class="business-type-item">
                                            <i class="fas fa-running"></i>
                                            <span>Shoes</span>
                                        </a>
                                        <a href="<?php echo base_url('industries/apparel-footwear'); ?>" class="business-type-item">
                                        ...
                                        <div class="view-all-link">
                                            <a href="<?php echo base_url('industries/apparel-footwear'); ?>">
                                                <i class="fas fa-arrow-right"></i>
                                                View All Apparel & Footwear
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="business-category" id="electronics-businesses">
                                        <a href="<?php echo base_url('industries/electronics-computers'); ?>" class="business-type-item">
                                            <i class="fas fa-camera"></i>
                                            <span>Camera & Accessories</span>
                                        </a>
                                        <a href="<?php echo base_url('industries/electronics-computers'); ?>" class="business-type-item">
                                        ...
                                        <div class="view-all-link">
                                            <a href="<?php echo base_url('industries/electronics-computers'); ?>">
                                                <i class="fas fa-arrow-right"></i>
                                                View All Electronics & Computers
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="business-category" id="hypermarket-businesses">
                                        <a href="<?php echo base_url('industries/hypermarket-departmental'); ?>" class="business-type-item">
                                            <i class="fas fa-building"></i>
                                        ...
                                        <div class="view-all-link">
                                            <a href="<?php echo base_url('industries/hypermarket-departmental'); ?>">
                                                <i class="fas fa-arrow-right"></i>
                                                View All Hypermarket & Departmental
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="business-category" id="lifestyle-businesses">
                                        <a href="<?php echo base_url('industries/lifestyle-fashion'); ?>" class="business-type-item">
                                            <i class="fas fa-gem"></i>
                                            <span>Jewelry</span>
                                        </a>
                                        <a href="<?php echo base_url('industries/lifestyle-fashion'); ?>" class="business-type-item">
                                        ...
                                        <div class="view-all-link">
                                            <a href="<?php echo base_url('industries/lifestyle-fashion'); ?>">
                                                <i class="fas fa-arrow-right"></i>
                                                View All Lifestyle & Fashion
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="business-category" id="pharma-businesses">
                                        <a href="<?php echo base_url('industries/pharma-healthcare'); ?>" class="business-type-item">
                                            <i class="fas fa-pills"></i>
                                            <span>Pharmacy</span>
                                        </a>
                                        <a href="<?php echo base_url('industries/pharma-healthcare'); ?>" class="business-type-item">
                                        ...
                                        <div class="view-all-link">
                                            <a href="<?php echo base_url('industries/pharma-healthcare'); ?>">
                                                <i class="fas fa-arrow-right"></i>
                                                View All Pharma & Healthcare
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="business-category" id="grocery-businesses">
                                        <a href="<?php echo base_url('industries/supermarket-groceries'); ?>" class="business-type-item">
                                            <i class="fas fa-shopping-basket"></i>
                                            <span>Supermarket</span>
                                        </a>
                                        <a href="<?php echo base_url('industries/supermarket-groceries'); ?>" class="business-type-item">
                                        ...
                                        <div class="view-all-link">
                                            <a href="<?php echo base_url('industries/supermarket-groceries'); ?>">
                                                <i class="fas fa-arrow-right"></i>
                                                View All Supermarket & Groceries
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="business-category" id="specialized-businesses">
                                        <a href="<?php echo base_url('industries/specialized-retail'); ?>" class="business-type-item">
                                            <i class="fas fa-car"></i>
                                        ...
                                        <div class="view-all-link">
                                            <a href="<?php echo base_url('industries/specialized-retail'); ?>">
                                                <i class="fas fa-arrow-right"></i>
                                                View All Specialized Retail
                                            </a>
                                        </div>
                                    </div>
                                </div>
